...
std::vector<std::pair<Particle*, Particle*>> ParticleContainerLinkedCell::getParticlePairsPeriodic(std::array<bool, 3> pFlag){
    std::vector<std::pair<Particle*, Particle*>> particlePairs; // The particle pairs we want to return.
...
inline size_t ParticleContainerLinkedCell::getParticlePairsPeriodicOneParticle(std::vector<std::pair<Particle*, Particle*>>& particlePairs, 
