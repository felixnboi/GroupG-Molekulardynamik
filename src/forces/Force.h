...
public:
     ...
     */
    inline void calculateFLennardJonesOnePair(const std::pair<Particle* const, Particle* const> &pair);
     ...
     */
    inline void calculateFPeriodicOnePair(const std::pair<Particle* const, Particle* const> &pair, bool i, bool j, bool k, ParticleContainerLinkedCell &LCContainer);
