...
inline void Force::calculateFLennardJonesOnePair(const std::pair<Particle* const, Particle* const> &pair){
...
inline void Force::calculateFPeriodicOnePair(const std::pair<Particle * const, Particle * const> &pair, bool i, bool j, bool k, ParticleContainerLinkedCell &LCContainer){
  auto particle_i = pair.first;
  auto particle_j = pair.second;
