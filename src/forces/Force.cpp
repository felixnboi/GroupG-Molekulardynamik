...
void Force::calculateF(ParticleContainer &particles) const {
...
void Force::calculateFLennardJones(std::vector<std::pair<Particle* const, Particle* const>> pairs) const {
...
inline void Force::calculateFLennardJonesOnePair(const std::pair<Particle* const, Particle* const> &pair) const {
...
void Force::calculateFGravitation(std::vector<std::pair<Particle* const, Particle* const>> pairs) const {
  for (auto& pair : pairs){
    auto particle_i = pair.first;
    auto particle_j = pair.second;
...
void Force::calculateFPeriodic(ParticleContainerLinkedCell &LCContainer) const {
...
inline void Force::calculateFPeriodicOnePair(const std::pair<Particle * const, Particle * const> &pair, bool i, bool j, bool k, ParticleContainerLinkedCell &LCContainer) const{
  auto particle_i = pair.first;
  auto particle_j = pair.second;
...
void Force::calculateFReflecting(ParticleContainerLinkedCell &LCContainer) const {
...
inline void Force::calculateFReflectingOneParticle(Particle* particle, ParticleContainerLinkedCell &LCContainer) const {
...
void Force::calculateFHarmonic(ParticleContainerLinkedCell &LCContainer) const {
